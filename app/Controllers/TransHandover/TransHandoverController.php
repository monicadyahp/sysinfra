...
//25-06 handover export pdf nama nya singkat 
...
public function export_pdf()
{
    ...
    // Fungsi format_name yang diperbarui dengan kedua ketentuan
    if (!function_exists('format_name')) {
        function format_name($name) {
            ...
            // Ketentuan baru: jika kata pertama memiliki lebih dari 5 karakter
            if (mb_strlen($firstWord) > 5) {
                $formattedName = mb_substr($firstWord, 0, 1) . '. ';
                if (isset($parts[1])) {
                    $secondWord = $parts[1];
                    $formattedName .= mb_substr($secondWord, 0, 5);
                }
                return trim($formattedName);
            } else {
                // Ketentuan sebelumnya: jika panjang total nama kurang dari atau sama dengan 7 karakter, kembalikan nama asli
                if (mb_strlen($name) <= 7) {
                    return $name;
                }

                // Ketentuan sebelumnya: logika pemotongan umum jika nama lebih dari 7 karakter
    ...
    foreach ($handoverDetails as $d) {
        ...
        // Menggunakan fungsi format_name yang dimodifikasi untuk Delivered SIC
        $pdf->Cell($cw['deliv_sic'], $rh, format_name($d->hd_deliveredname_rep), 1, 0, 'C');
        // Menggunakan fungsi format_name yang dimodifikasi untuk Delivered User
        ...
        // Menggunakan fungsi format_name yang dimodifikasi untuk Return SIC
        ...
        // Menggunakan fungsi format_name yang dimodifikasi untuk Return User
