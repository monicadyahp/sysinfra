...
!(function (e, n) {
   ...
   function k(p, v) {
      ...
      function K(e, n) {
         for (
            var t =
                  (new Date(e, n, 1).getDay() - w.l10n.firstDayOfWeek + 7) % 7,
      ...
      function ne(e, n) {
         ...
         if (
            (w.config.minDate &&
               a &&
               M(a, w.config.minDate, void 0 !== n ? n : !w.minDateHasTime) <
                  0) ||
            (w.config.maxDate &&
               a &&
         ...
         if ("function" != typeof w.config.position) {
            if (void 0 !== w.calendarContainer) {
               ...
               if (
                  ...
                  if (
                     (s(w.calendarContainer, "rightMost", h), !w.config.static)
                  )
            ...
            (w.element = w.input = p),
               ...
               (function () {
                  var n = [
                     ...
                     i = e(
                        e({}, JSON.parse(JSON.stringify(p.dataset || {}))),
                        v
                     ),
                     o = {};
                  ...
                  var d = function (e) {
                     return function (n) {
                        w.config["min" === e ? "_minTime" : "_maxTime"] =
                           w.parseDate(n, "H:i:S");
                     };
                  };
                     ...
                     P(w.timeContainer, ["increment"], _),
                        ...
                        void 0 !== w.secondElement &&
                           P(w.secondElement, "focus", function () {
                              return (
                                 w.secondElement && w.secondElement.select()
                              );
                           }),
                        void 0 !== w.amPM &&
