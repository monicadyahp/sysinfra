...
function init_sidebar() {
   function t() {
      ...
      var e = $BODY.outerHeight(),
         ...
         o = e < t ? t : e;
      (o -= $NAV_MENU.height() + a),
         // from o to manual value
         $RIGHT_COL.css("min-height", "calc(100vh - 55px)");
   }
   function o() {
         ...
         $BODY.hasClass("nav-md")
            ? ($SIDEBAR_MENU.find("li.active ul").hide(),
              $SIDEBAR_MENU
                 ...
                 .addClass("active-sm")
                 .removeClass("active"),
              $(".group-link").addClass("flex-column").removeClass("gap-2"),
            ...
            : ($SIDEBAR_MENU.find("li.active-sm ul").show(),
              ...
              $(".group-link").addClass("gap-2").removeClass("flex-column"),
...
function countChecked() {
   ...
   e
      ? ($(".column-title").hide(),
        $(".bulk-actions").show(),
        $(".action-cnt").html(e + " Records Selected"))
...
function init_flot_chart() {
   if (void 0 !== $.plot) {
      for (
         ...
         t.push([
            new Date(Date.today().add(o).days()).getTime(),
            Math.floor(21 * Math.random()) + 20 + o + o + 10,
         ]);
      var n = {
         grid: {
            show: !0,
      ...
      $("#chart_plot_01").length &&
         (console.log("Plot1"),
         $.plot($("#chart_plot_01"), [e, a], {
            series: {
               lines: { show: !1, fill: !0 },
               splines: { show: !0, tension: 0.4, lineWidth: 1, fill: 0.4 },
...
function init_gauge() {
   if ("undefined" != typeof Gauge) {
      var e = {
         ...
         angle: 0,
         lineWidth: 0.4,
         pointer: { length: 0.75, strokeWidth: 0.042, color: "#1D212A" },
         limitMax: "false",
         colorStart: "#1ABC9C",
         colorStop: "#1ABC9C",
         strokeColor: "#F0F3F3",
      ...
      if ($("#chart_gauge_01").length)
         var a = document.getElementById("chart_gauge_01"),
      ...
      if (
         ($("#gauge-text").length &&
            ...
            (t.animationSpeed = 32),
            t.set(3200),
            t.setTextField(document.getElementById("gauge-text"))),
         $("#chart_gauge_02").length)
      )
         var o = document.getElementById("chart_gauge_02"),
            n = new Gauge(o).setOptions(e);
      $("#gauge-text2").length &&
         ((n.maxValue = 9e3),
         (n.animationSpeed = 32),
         n.set(2400),
         n.setTextField(document.getElementById("gauge-text2")));
   }
}
function init_sparklines() {
   void 0 !== jQuery.fn.sparkline &&
      ...
      $(".sparkline_bar").sparkline(
         ...
         { type: "bar", colorMap: { 7: "#a1a1a1" }, barColor: "#26B99A" }
      ),
...
function init_wysiwyg() {
   function a(e, a) {
      ...
      "unsupported-file-type" === e
         ? (t = "Unsupported format " + a)
         : console.log("error uploading file", e, a),
         $(
   ...
   if (void 0 !== $.fn.cropper) {
      var i = $("#image"),
         ...
         d = {
            ...
            preview: ".img-preview",
            crop: function (e) {
               a.val(Math.round(e.x)),
                  t.val(Math.round(e.y)),
                  o.val(Math.round(e.height)),
      ...
      $('[data-toggle="tooltip"]').tooltip(),
         ...
         void 0 === n[0].download && n.addClass("disabled"),
         $(".docs-toggles").on("change", "input", function () {
            ...
            i.data("cropper") &&
               ("checkbox" === n
                  ? ((d[o] = t.prop("checked")),
                    (e = i.cropper("getCropBoxData")),
                    (a = i.cropper("getCanvasData")),
                    (d.built = function () {
                       i.cropper("setCropBoxData", e),
                          i.cropper("setCanvasData", a);
                    }))
                  : "radio" === n && (d[o] = t.val()),
               i.cropper("destroy").cropper(d));
         }),
         $(".docs-buttons").on("click", "[data-method]", function () {
            ...
            if (
               ...
               if (
                  void 0 !== (o = $.extend({}, o)).target &&
                  ((e = $(o.target)), void 0 === o.option)
               )
                  try {
               ...
               switch (
                  ((a = i.cropper(o.method, o.option, o.secondOption)),
                  o.method)
               ) {
                  case "scaleX":
                  case "scaleY":
                  ...
                  case "getCroppedCanvas":
                     a &&
                        ($("#getCroppedCanvasModal")
                           ...
                           .html(a),
                        n.hasClass("disabled") ||
                           n.attr("href", a.toDataURL()));
               }
               if ($.isPlainObject(a) && e)
                  try {
         ...
         $(document.body).on("keydown", function (e) {
            if (i.data("cropper") && !(300 < this.scrollTop))
               switch (e.which) {
                  case 37:
   ...
   if (void 0 !== $.fn.knob) {
      ...
      $("input.infinite").knob({
         ...
         change: function () {
            e > this.cv
               ? a
                  ? (o--, n.show().html("-").fadeOut(), i.html(o), (a = 0))
                  : ((a = 1), (t = 0))
               : e < this.cv &&
                 (t
                    ? (o++, n.show().html("+").fadeOut(), i.html(o), (t = 0))
                    : ((t = 1), (a = 0))),
               (e = this.cv);
         },
      });
...
function init_ColorPicker() {
   void 0 !== $.fn.colorpicker &&
      ($(".demo1").colorpicker(),
      $(".demo2").colorpicker(),
      $("#demo_forceformat").colorpicker({ format: "rgba", horizontal: !0 }),
      $("#demo_forceformat3").colorpicker({ format: "rgba" }),
      $(".demo-auto").colorpicker());
}
function init_IonRangeSlider() {
   void 0 !== $.fn.ionRangeSlider &&
   ...
   if (void 0 !== $.fn.daterangepicker) {
      function e(e, a, t) {
         $("#reportrange span").html(
            e.format("MMMM D, YYYY") + " - " + a.format("MMMM D, YYYY")
         );
      }
      var a = {
      ...
      $("#reportrange span").html(
         ...
         $("#reportrange").daterangepicker(a, e),
         ...
         $("#reportrange").on("apply.daterangepicker", function (e, a) {
            console.log(
               "apply event fired, start/end dates are " +
                  a.startDate.format("MMMM D, YYYY") +
                  " to " +
                  a.endDate.format("MMMM D, YYYY")
            );
         }),
...
function init_daterangepicker_right() {
   if (void 0 !== $.fn.daterangepicker) {
      ...
      $("#reportrange_right span").html(
         ...
         $("#reportrange_right").daterangepicker(a, e),
      ...
      (TabbedNotification = function (e) {
         ...
         document.getElementById("custom_notifications")
            ? ($("#custom_notifications ul.notifications").append(
              ...
              $("#custom_notifications #notif-group").append(a),
              t++,
              CustomTabs(e))
            : alert("doesnt exists");
      }),
...
function init_EasyPieChart() {
   if (void 0 !== $.fn.easyPieChart) {
      ...
      ($.fn.popover.Constructor.prototype.leave = function (e) {
         ...
         n.call(this, e),
            e.currentTarget &&
               ((a = $(e.currentTarget).siblings(".popover")),
               (t = o.timeout),
...
function init_charts() {
   if ("undefined" != typeof Chart) {
      if (
         ((Chart.defaults.global.legend = { enabled: !1 }),
         $("#canvas_line").length)
      )
      ...
      if ($("#mybarChart").length)
         (e = document.getElementById("mybarChart")),
            new Chart(e, {
               type: "bar",
               data: {
                  labels: [
      ...
      if ($("#canvasRadar").length)
         (e = document.getElementById("canvasRadar")),
            (a = {
               labels: [
                  "Eating",
                  "Drinking",
            ...
            new Chart(e, { type: "radar", data: a });
      if ($("#pieChart").length)
         (e = document.getElementById("pieChart")),
            (a = {
               datasets: [
                  {
                     data: [120, 50, 140, 180, 100],
      ...
      if ($("#polarArea").length)
         (e = document.getElementById("polarArea")),
            (a = {
               datasets: [
                  {
                     data: [120, 50, 140, 180, 100],
            ...
            new Chart(e, {
               data: a,
               type: "polarArea",
               options: { scale: { ticks: { beginAtZero: !0 } } },
            });
   }
}
function init_compose() {
   void 0 !== $.fn.slideToggle &&
                  ...
                  $(".antosubmit").on("click", function () {
                     ...
                     return (
                        ...
                        e &&
                           i.fullCalendar(
                              "renderEvent",
                              { title: e, start: o, end: a, allDay: t },
                              !0
                           ),
                        $("#title").val(""),
...
function init_echarts() {
   if ("undefined" != typeof echarts) {
      ...
      if ($("#mainb").length)
         echarts.init(document.getElementById("mainb"), e).setOption({
            ...
            series: [
               {
                  ...
                  type: "bar",
                  data: [
                     2, 4.9, 7, 23.2, 25.6, 76.7, 135.6, 162.2, 32.6, 20, 6.4,
                     3.3,
                  ],
                  markPoint: {
                     data: [
               ...
               },
               {
                  ...
                  type: "bar",
                  data: [
                     2.6, 5.9, 9, 26.4, 28.7, 70.7, 175.6, 182.2, 48.7, 18.8, 6,
                     2.3,
                  ],
                  markPoint: {
                     data: [
                        { name: "sales", value: 182.2, xAxis: 7, yAxis: 183 },
                        { name: "purchases", value: 2.3, xAxis: 11, yAxis: 3 },
                     ],
                  },
                  markLine: { data: [{ type: "average", name: "???" }] },
               },
      ...
      if ($("#echart_sonar").length)
         echarts.init(document.getElementById("echart_sonar"), e).setOption({
      ...
      if ($("#echart_pyramid").length)
         echarts.init(document.getElementById("echart_pyramid"), e).setOption({
            ...
            series: [
               {
                  ...
                  width: "40%",
                  data: [
                     { value: 60, name: "Something #1" },
                     { value: 40, name: "Something #2" },
                     { value: 20, name: "Something #3" },
                     { value: 80, name: "Something #4" },
      ...
      if ($("#echart_gauge").length)
         echarts.init(document.getElementById("echart_gauge"), e).setOption({
      ...
      if ($("#echart_scatter").length)
         echarts.init(document.getElementById("echart_scatter"), e).setOption({
            ...
            toolbox: {
               show: !0,
               feature: { saveAsImage: { show: !0, title: "Save Image" } },
            },
            xAxis: [
               {
                  type: "value",
      ...
      if ($("#echart_bar_horizontal").length)
         echarts
            .init(document.getElementById("echart_bar_horizontal"), e)
            .setOption({
      ...
      if ($("#echart_pie").length) {
         ...
         var a = { normal: { label: { show: !1 }, labelLine: { show: !1 } } },
            t = {
               normal: {
                  color: "rgba(0,0,0,0)",
                  label: { show: !1 },
      ...
      if ($("#echart_mini_pie").length)
         echarts.init(document.getElementById("echart_mini_pie"), e).setOption({
            title: {
               text: "Chart #2",
            ...
            series: [
               {
                  ...
                  itemStyle: a,
                  data: [
                     { value: 68, name: "68%Something #1" },
                     { value: 32, name: "invisible", itemStyle: t },
                  ],
               },
               {
                  name: "2",
                  ...
                  itemStyle: a,
                  data: [
                     { value: 29, name: "29%Something #2" },
                     { value: 71, name: "invisible", itemStyle: t },
                  ],
               },
               {
                  name: "3",
                  ...
                  itemStyle: a,
                  data: [
                     { value: 3, name: "3%Something #3" },
                     { value: 97, name: "invisible", itemStyle: t },
                  ],
               },
            ],
         });
      if ($("#echart_world_map").length)
         echarts
            .init(document.getElementById("echart_world_map"), e)
            .setOption({
               title: {
