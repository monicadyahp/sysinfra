...
(function (root, factory) {
   ...
   var asciifold = (function () {
      ...
      return function (str) {
         return str
            .replace(regexp, function (i18nChar) {
   ...
   var autoGrow = function ($input) {
      ...
      var update = function (e, options) {
         ...
         width =
            Math.max(measureString(value, $input), placeholderWidth) + width;
   ...
   var Selectize = function ($input, settings) {
      ...
      self.settings.mode =
         self.settings.mode ||
         (self.settings.maxItems === 1 ? "single" : "multi");
   ...
   $.extend(Selectize.prototype, {
      setup: function () {
         ...
         $wrapper = $("<div>")
            ...
            .addClass(classes + " selectize-control")
            .addClass(inputMode);
         $control = $("<div>")
            .addClass(
               settings.inputClass + noArrowClass + " selectize-input items"
            )
            .appendTo($wrapper);
         $control_input = $(
         ...
         $dropdown = $("<div>")
            ...
            .addClass(inputMode + " selectize-dropdown")
            .hide()
            .appendTo($dropdown_parent);
         $dropdown_content = $("<div>")
            .addClass(
               settings.dropdownContentClass + " selectize-dropdown-content"
            )
            .attr("tabindex", "-1")
            .appendTo($dropdown);
      ...
      setMaxItems: function (value) {
         ...
         this.settings.mode =
            this.settings.mode ||
            (this.settings.maxItems === 1 ? "single" : "multi");
         this.refreshState();
      },
      ...
      setActiveOption: function ($option, scroll, animate) {
         ...
         if (self.$activeOption) {
            ...
            self.trigger(
               ...
               self.$activeOption.attr("data-value")
            );
         }
      ...
      refreshOptions: function (triggerDropdown) {
         ...
         for (i = 0; i < n; i++) {
            ...
            for (j = 0, k = optgroups && optgroups.length; j < k; j++) {
               ...
               if (
                  ...
                  typeof self.settings.optionGroupRegister === "function"
               ) {
                  var regGroup;
                  if (
                     (regGroup = self.settings.optionGroupRegister.apply(self, [
                        optgroup,
                     ]))
                  ) {
         ...
         self.hasOptions =
            ...
            self.settings.setFirstOptionActive;
      ...
      createItem: function (input, triggerDropdown) {
            ...
            typeof self.settings.create === "function"
               ...
               : function (input) {
                    ...
                    if (
                       ...
                       typeof self.settings.formatValueToKey === "function"
                    ) {
         ...
         var create = once(function (data) {
            ...
            self.addItem(value);
            self.refreshOptions(
               triggerDropdown && self.settings.mode !== "single"
            );
            callback(data);
         });
      ...
      updateOriginalInput: function (opts) {
         ...
         if (self.tagType === TAG_SELECT) {
            ...
            if (
               existing.length - old.length + fresh.length === 0 &&
               !self.$input.attr("multiple")
            ) {
      ...
      positionDropdown: function () {
         ...
         var w =
            this.$wrapper[0].style.width !== "fit-content"
               ? this.settings.dropdownParent === "body"
                  ? "max-content"
                  : "100%"
               : "max-content";
         ...
         if (
            this.settings.dropdownParent !== "body" &&
            w === "max-content" &&
            $control.outerWidth(true) >= this.$dropdown.outerWidth(true)
         ) {
            w = "100%";
         }
      ...
      setupDropdownHeight: function () {
         if (
            typeof this.settings.dropdownSize === "object" &&
            this.settings.dropdownSize.sizeType !== "auto"
         ) {
            var height = this.settings.dropdownSize.sizeValue;

            if (this.settings.dropdownSize.sizeType === "numberItems") {
               var $items = this.$dropdown_content
                  .find("*")
                     ...
                     if ($item.hasClass("optgroup-header")) {
                        ...
                        if (styles) {
                           marginTop = styles.marginTop
                              ? Number(
                                   styles.marginTop.replace(/\W*(\w)\w*/g, "$1")
                                )
                              : 0;
                           marginBottom = styles.marginBottom
                              ? Number(
                                   styles.marginBottom.replace(
                                      /\W*(\w)\w*/g,
                                      "$1"
                                   )
                                )
                              : 0;
                           separatorHeight = styles.borderTopWidth
                              ? Number(
                                   styles.borderTopWidth.replace(
                                      /\W*(\w)\w*/g,
                                      "$1"
                                   )
                                )
               ...
               var paddingTop = this.$dropdown_content.css("padding-top")
                  ? Number(
                  ...
                  : 0;
               var paddingBottom = this.$dropdown_content.css("padding-bottom")
                  ? Number(
                       this.$dropdown_content
                          .css("padding-bottom")
                          .replace(/\W*(\w)\w*/g, "$1")
      ...
      deleteSelection: function (e) {
         ...
         if (self.$activeOption && !self.settings.hideSelected) {
            if (
               typeof self.settings.deselectBehavior === "string" &&
               self.settings.deselectBehavior === "top"
            ) {
   ...
   Selectize.define("auto_position", function () {
      ...
      self.positionDropdown = (function () {
         return function () {
            ...
            const controlPosTop = this.$control
               .get(0)
               .getBoundingClientRect().top;
            const wrapperHeight = this.$wrapper.height();
            const controlPosBottom = self.$control
               .get(0)
            ...
            if (position === POSITION.top) {
               ...
               if (this.settings.dropdownParent === "body") {
                  styleToAdd.top =
                     offset.top -
                     this.$dropdown.outerHeight(true) -
   ...
   Selectize.define("auto_select_on_type", function (options) {
      ...
      self.onBlur = (function () {
         ...
         return function (e) {
            ...
            if (
               typeof $matchedItem.attr("data-value") !== "undefined" &&
   ...
   Selectize.define("read-only", function (options) {
      ...
      this.setup = (function () {
         ...
         return function () {
            original.apply(this, arguments);
            if (this.$dropdown.hasClass("read-only"))
   ...
   Selectize.define("tag_limit", function (options) {
      ...
      this.onBlur = (function (e) {
         ...
         return function (e) {
            ...
            $control.append(
               "<span><b>" + ($items.length - limit) + "</b></span>"
            );
         };
      })();
